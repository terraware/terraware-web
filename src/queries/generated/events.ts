...
export type PlantingDateRequestSpeciesSubjectPayload = {
...
export type PlantingDateRequestSubjectPayload = {
...
export type PlantingSeasonAllocatedSpeciesSubjectPayload = {
...
export type PlantingSeasonSpeciesTargetSubjectPayload = {
...
export type ListEventLogEntriesRequestPayload = {
  ...
  subjects?: (
    ...
    | 'PlantingSeason'
    | 'PlantingSeasonAllocatedSpecies'
