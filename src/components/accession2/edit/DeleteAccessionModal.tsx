...
export default function DeleteAccessionModal(props: DeleteAccessionModalProps): JSX.Element {
  ...
  return (
    <DialogBox
      ...
      size='medium'
      middleButtons={[
        <Button id='cancelDeleteAccession' label={strings.CANCEL} type='passive' onClick={onClose} priority='secondary' key='button-1' />,
        <Button id='saveDeleteAccession' onClick={deleteHandler} type='destructive' label={strings.DELETE} key='button-2' />,
      ]}
