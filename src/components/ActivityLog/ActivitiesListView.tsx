...
const ActivitiesListView = ({
  ...
  } = useListActivitiesQuery({ projectId, depth: 'All' }, { skip: isAcceleratorRoute || isFunderRoute });
  ...
  } = useAdminListActivitiesQuery({ projectId, depth: 'All' }, { skip: !isAcceleratorRoute || isFunderRoute });
