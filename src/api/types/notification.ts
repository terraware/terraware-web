...
export type NotificationsListResponse = paths[typeof notificationsEndpoint]['get']['responses'][200]['content']['application/json'];
...
export type NotificationMarkReadPostResponse = paths[typeof notificationsMarkAllReadEndpoint]['post']['responses'][200]['content']['application/json'];

export const notificationsMarkAllReadEndpoint = '/api/v1/seedbank/notification/all/markRead';
export type NotificationMarkAllReadPostResponse = paths[typeof notificationsMarkAllReadEndpoint]['post']['responses'][200]['content']['application/json'];
