...
const strings = new LocalizedStrings({
  en: {
    ...
    DONE: 'Done',
    MISSING_SUBSET_WEIGHT_ERROR_VIABILITY_TEST: 'You must enter in a subset weight in order to create a viability test',
    MISSING_SUBSET_WEIGHT_ERROR_NURSERY: 'You must enter in a subset weight in order to withdraw to a nursery',
    SET_UP: 'Set Up',
