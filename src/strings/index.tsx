...
const strings = new LocalizedStrings({
  en: {
    ...
    ACCESSIONS_ADD_TOOLTIP_COLLECTING_SITE: 'The place where seeds were collected. It is recommended to name these referencing stable landmarks or features that do not change.',
    ACCESSIONS_ADD_TOOLTIP_COLLECTION_SOURCE: 'The type of plant population where seeds are collected. (Learn more.)',
