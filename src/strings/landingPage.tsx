...
const strings = new LocalizedStrings({
  en: {
    ...
    SUBTITLE_GET_STARTED: 'To get started, please create your organization now. You\'ll also be able to set up and manage information on projects, sites, people, and species.',
    ...
    FOOTNOTE_WAIT_FOR_INVITATION: 'Not interested in creating your own organization or expecting an invitation? Don’t worry. You’ll receive an email when your admin adds you to the organization.',
  },
});
