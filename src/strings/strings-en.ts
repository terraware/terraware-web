export const strings = {
  ...
  REPORT_NURSERY_BUILD_START_DATE_INVALID: 'Must be before build completed date.',
  REPORT_NURSERY_CAPACITY: 'Nursery Capacity *',
  REPORT_NURSERY_OPERATION_START_DATE: 'Nursery Operation Start Date *',
  REPORT_NURSERY_OPERATION_START_DATE_INVALID: 'Must be after build completed date.',
