export const strings = {
  ...
  REPORT_NURSERY_BUILD_COMPLETION_DATE: 'Nursery Build Completion Date *',
  REPORT_NURSERY_BUILD_START_DATE: 'Nursery Build Start Date *',
  REPORT_NURSERY_CAPACITY: 'Nursery Capacity *',
  REPORT_NURSERY_OPERATION_START_DATE: 'Nursery Operation Start Date *',
  ...
  SDG_NO_POVERTY: '1. No Poverty',
  SDG_ZERO_HUNGER: '2. Zero Hunger',
  SDG_GOOD_HEALTH_AND_WELL_BEING: '3. Good Health and Well-Being',
  SDG_QUALITY_EDUCATION: '4. Quality Education',
  SDG_GENDER_EQUALITY: '5. Gender Equality',
  SDG_CLEAN_WATER_AND_SANITATION: '6. Clean Water and Sanitation',
  SDG_AFFORDABLE_AND_CLEAN_ENERGY: '7. Affordable and Clean Energy',
  SDG_DECENT_WORK_AND_ECONOMIC_GROWTH: '8. Decent Work and Economic Growth',
  SDG_INDUSTRY_INNOVATION_AND_INFRASTRUCTURE: '9. Industry, Innovation, and Infrastructure',
  SDG_REDUCED_INEQUALITIES: '10. Reduced Inequalities',
  SDG_SUSTAINABLE_CITIES_AND_COMMUNITIES: '11. Sustainable Cities and Communities',
  SDG_RESPONSIBLE_CONSUMPTION_AND_PRODUCTION: '12. Responsible Consumption and Production',
  SDG_CLIMATE_ACTION: '13. Climate Action',
  SDG_LIFE_BELOW_WATER: '14. Life Below Water',
  SDG_LIFE_ON_LAND: '15. Life on Land',
  SDG_PEACE_JUSTICE_AND_STRONG_INSTITUTIONS: '16. Peace, Justice, and Strong Institutions.',
  SDG_PARTNERSHIPS_FOR_THE_GOALS: '17. Partnerships for the Goals',
  ...
  WORKERS_PAID_ENGAGED: 'Paid Workers Engaged *',
