export const strings = {
  ...
  FACILITY_BUILD_COMPLETION_DATE_REQUIRED: 'Nursery Build Completion Date *',
  FACILITY_BUILD_COMPLETION_DATE: 'Nursery Build Completion Date',
  FACILITY_BUILD_START_DATE_INVALID: 'Must be on or before build completed date and operation start dates.',
  FACILITY_BUILD_START_DATE_REQUIRED: 'Nursery Build Start Date *',
  FACILITY_BUILD_START_DATE: 'Nursery Build Start Date',
  FACILITY_OPERATION_START_DATE_INVALID: 'Must be on or after build start and build completed dates.',
  FACILITY_OPERATION_START_DATE_REQUIRED: 'Nursery Operation Start Date *',
  FACILITY_OPERATION_START_DATE: 'Nursery Operation Start Date',
  FACILITY: 'Facility',
