export const strings = {
  ...
  ADD_PHOTOS_DESCRIPTION:
    'Take a photo (or photos) of the batches that will be planted at the selected subzone. Be sure to include the entire withdrawal in the photo(s).',
  ...
  REASSIGN_SEEDLINGS_DESCRIPTION:
    'Enter the new subzone, new quantity, and notes for the species you want to reassign seedlings for. The seedlings for rows you leave empty will not be reassigned.',
  ...
  REPORT_NURSERY_BUILD_COMPLETION_DATE_INVALID: 'Must be between build start and operation start dates.',
  REPORT_NURSERY_BUILD_START_DATE: 'Nursery Build Start Date *',
  REPORT_NURSERY_BUILD_START_DATE_INVALID: 'Must be on or before build completed date.',
  REPORT_NURSERY_CAPACITY: 'Nursery Capacity *',
  REPORT_NURSERY_OPERATION_START_DATE: 'Nursery Operation Start Date *',
  REPORT_NURSERY_OPERATION_START_DATE_INVALID: 'Must be on or after build completed date.',
