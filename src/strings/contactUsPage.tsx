...
const strings = new LocalizedStrings({
  en: {
    DESCRIPTION_REPORT_PROBLEM: `If you’re having trouble using Terraware, please report any issues you’re having and we’ll make it right. Let us know this build version "${process.env.REACT_APP_TERRAWARE_FE_BUILD_VERSION}".`,
