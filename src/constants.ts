...
export enum APP_PATHS {
  ...
  OBSERVATION_DETAILS = '/observations/:plantingSiteId/:observationId',
  OBSERVATION_PLANTING_ZONE_DETAILS = '/observations/:plantingSiteId/:observationId/:plantingZoneId',
  OBSERVATION_MONITORING_PLOT_DETAILS = '/observations/:plantingSiteId/:observationId/:plantingZoneId/:monitoringPlotId',
  OPT_IN = '/opt-in',
