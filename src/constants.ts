...
export enum APP_PATHS {
  ...
  ACCELERATOR_SPECIES_EDIT = '/accelerator/deliverables/:deliverableId/submissions/:projectId/species/:acceleratorProjectSpeciesId/edit',
  ...
  OBSERVATION_VIRTUAL_MONITORING_PLOT = '/observations/:observationId/stratum/:stratumName/plot/:monitoringPlotId/virtual/:fileId',
  ...
  SURVIVAL_RATE_SETTINGS_V2 = '/observations/survival-rate-settings/:plantingSiteId',
