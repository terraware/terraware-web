...
const makeAdHocObservationsCsv = (adHocObservations: AdHocObservationResults[]): Blob => {
  ...
  const data = adHocObservations.map((adHocObservation: AdHocObservationResults) => {
    ...
    return {
      ...
      northwestLatitude: plotBoundaryCoordinates[1][1],
      northwestLongitude: plotBoundaryCoordinates[1][0],
      southeastLatitude: plotBoundaryCoordinates[2][1],
      southeastLongitude: plotBoundaryCoordinates[2][0],
      northeastLatitude: plotBoundaryCoordinates[3][1],
      northeastLongitude: plotBoundaryCoordinates[3][0],
