...
export default function AggregatedPlantsStats({
  ...
  return (
    <Box display='flex' flexDirection='column' width={'100%'} marginBottom={theme.spacing(3)}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={chartGridSize}>
          ...
          >
            <SpeciesTotalPlantsChart chartId={'observationSpeciesTotalChart'} species={species} minHeight='170px' />
          </ChartWrapper>
        </Grid>
        <Grid item xs={chartGridSize}>
          <ChartWrapper
