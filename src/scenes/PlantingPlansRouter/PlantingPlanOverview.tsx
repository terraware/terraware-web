  ...
  return (
    ...
    >
      <Box display='flex' alignItems='center' gap={theme.spacing(3)} flexWrap='wrap' width='100%'>
        ...
        <PlantingPlanStatTile label={strings.TARGET_PLANTING_DENSITY} value={PLACEHOLDER} showDivider />
        <PlantingPlanStatTile label={strings.TARGET_SPECIES} value={PLACEHOLDER} showDivider />
        <PlantingPlanStatTile label={strings.STRATA} value={strataCount} showDivider />
      </Box>
