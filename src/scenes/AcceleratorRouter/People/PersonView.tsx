...
import { requestGetGlobalRolesUser } from 'src/redux/features/globalRoles/globalRolesAsyncThunks';
import { selectGlobalRolesUser } from 'src/redux/features/globalRoles/globalRolesSelectors';
...
const PersonView = () => {
  ...
  const goToEditPerson = useCallback(
    () => history.push(getLocation(APP_PATHS.ACCELERATOR_PERSON_EDIT.replace(':userId', pathParams.userId), location)),
