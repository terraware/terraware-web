...
export const getPhaseString = (phase: PhaseType): string => {
  switch (phase) {
    case 'Phase 0 - Due Diligence':
      return strings.PROJECT_PHASE_DUE_DILIGENCE;
    case 'Phase 1 - Feasibility Study':
      return strings.PROJECT_PHASE_FEASIBILITY_STUDY;
    case 'Phase 2 - Plan and Scale':
      return strings.PROJECT_PHASE_PLAN_AND_SCALE;
    case 'Phase 3 - Implement and Monitor':
      return strings.PROJECT_PHASE_IMPLEMENT_AND_MONITOR;
    default:
      return '';
  }
};
