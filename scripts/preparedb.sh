...
curl 'http://localhost:4000/api/v1/species' \q
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
}'
curl 'http://localhost:4000/api/v1/species_names' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  --data '{"name":"Banana","species_id": 1 }'

curl 'http://localhost:4000/api/v1/species' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
}'
...
FEATURE_ID=$(curl 'http://localhost:4000/api/v1/features' \
  -H 'Content-Type: application/json' \
...
curl "http://localhost:4000/api/v1/photos?feature_id=${FEATURE_ID}&captured_time=2021-02-03T11%3A33%3A44Z" \
  -H 'accept: application/json' \
  -H 'Content-Type: multipart/form-data' \
  -F 'file=@./scripts/banana.jpeg;type=image/jpeg'
curl 'http://localhost:4000/api/v1/plants' \
  -H 'Content-Type: application/json' \
  --data '{"feature_id": 1,"label": "Plant 1","species_id": 1}'

FEATURE_ID_2=$(curl 'http://localhost:4000/api/v1/features' \
  -H 'Content-Type: application/json' \
...
curl "http://localhost:4000/api/v1/photos?feature_id=${FEATURE_ID_2}&captured_time=2021-02-03T11%3A33%3A44Z" \
  -H 'accept: application/json' \
  -H 'Content-Type: multipart/form-data' \
  -F 'file=@./scripts/banana.jpeg;type=image/jpeg'
curl 'http://localhost:4000/api/v1/plants' \
...
FEATURE_ID_3=$(curl 'http://localhost:4000/api/v1/features' \
  -H 'Content-Type: application/json' \
...
curl "http://localhost:4000/api/v1/photos?feature_id=${FEATURE_ID_3}&captured_time=2021-02-03T11%3A33%3A44Z" \
  -H 'accept: application/json' \
  -H 'Content-Type: multipart/form-data' \
  -F 'file=@./scripts/banana.jpeg;type=image/jpeg'
curl 'http://localhost:4000/api/v1/plants' \
...
FEATURE_ID_4=$(curl 'http://localhost:4000/api/v1/features' \
  -H 'Content-Type: application/json' \
...
curl "http://localhost:4000/api/v1/photos?feature_id=${FEATURE_ID_4}&captured_time=2021-02-03T11%3A33%3A44Z" \
  -H 'accept: application/json' \
  -H 'Content-Type: multipart/form-data' \
  -F 'file=@./scripts/banana.jpeg;type=image/jpeg'
curl 'http://localhost:4000/api/v1/plants' \
