...
export const changeToSuperAdmin = async (context: BrowserContext, baseURL: string) => {
...
export const changeToFunderUser = async (context: BrowserContext, baseURL: string) => {
  await context.clearCookies({ name: 'SESSION' });
  await context.addCookies([
...
export const changeToContributor = async (context: BrowserContext, baseURL: string) => {
  await context.clearCookies({ name: 'SESSION' });
  await context.addCookies([
...
export const changeToReadOnlyUser = async (context: BrowserContext, baseURL: string) => {
  await context.clearCookies({ name: 'SESSION' });
  await context.addCookies([
