...
INSERT INTO "accession" ("id", "site_module_id", "app_device_id", "number", "species_id", "collected_date", "received_date", "state_id", "primary_collector_id", "founder_id", "trees_collected_from", "environmental_notes", "field_notes", "processing_start_date", "seeds_counted", "subset_weight", "subset_count", "total_weight", "est_seed_count", "cut_test_seeds_filled", "cut_test_seeds_empty", "cut_test_seeds_compromised", "drying_start_date", "drying_end_date", "drying_move_date", "processing_notes", "storage_start_date", "storage_packets", "storage_location_id", "storage_notes", "species_family_id", "created_time", "processing_method_id", "target_storage_condition", "processing_staff_responsible", "collection_site_name", "collection_site_landowner", "storage_staff_responsible", "seeds_remaining", "latest_germination_recording_date", "latest_viability_percent", "total_viability_percent", "effective_seed_count", "species_endangered_type_id", "species_rare_type_id") VALUES
(1002,	100,	1,	'AAF4D49R3E',	10000,	NULL,	NULL,	30,	NULL,	NULL,	1,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	20000,	'2021-01-03 15:31:20+00',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL);
