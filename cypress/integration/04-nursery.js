...
describe('Nursery', () => {
  ...
  it('should create the accession with nursery test and navigate to nursery section', () => {
    ...
    cy.get('#nursery > .MuiTypography-root')
      .click()
      .url()
  ...
  it('should create a new test', () => {
    ...
    cy.get('.MuiTableRow-root > :nth-child(1) > .MuiTypography-root').should(
      'contain',
      '02/09/2021'
    );
    cy.get('.MuiTableRow-root > :nth-child(2) > .MuiTypography-root').should(
      'contain',
      'Stored'
    );
    cy.get('.MuiTableRow-root > :nth-child(3) > .MuiTypography-root').should(
      'contain',
      'Paper Petri Dish'
    );
    cy.get('.MuiTableRow-root > :nth-child(4) > .MuiTypography-root').should(
      'contain',
      'Scarify'
    );
    cy.get('.MuiTableRow-root > :nth-child(5) > .MuiTypography-root').should(
      'contain',
      '100'
    );
    cy.get('.MuiTableRow-root > :nth-child(6) > .MuiTypography-root').should(
      'contain',
      '50'
    );
    cy.get('.MuiTableRow-root > :nth-child(7) > .MuiTypography-root').should(
      'contain',
      '02/09/2021'
    );
    cy.get('.MuiTableRow-root > :nth-child(8) > .MuiTypography-root')
      .children()
  ...
  it('should modify test', () => {
    cy.get(
      ':nth-child(1) > :nth-child(9) > .MuiLink-root > .MuiBox-root > .MuiTypography-root'
    ).click();
    cy.get('#substrate').click();
  ...
  it('should display the records in the right order', () => {
    ...
    cy.get('.MuiTableBody-root > :nth-child(3) > :nth-child(6)').contains(
      '100'
    );

    // by recording date
    cy.get('.MuiTableRow-root > :nth-child(7) > .MuiButtonBase-root').click();
    cy.get('.MuiTableBody-root > :nth-child(1) > :nth-child(7)').contains(
      '01/25/2021'
    );
    cy.get('.MuiTableBody-root > :nth-child(2) > :nth-child(7)').contains(
      '02/10/2021'
    );
    cy.get('.MuiTableBody-root > :nth-child(3) > :nth-child(7)').contains(
      '02/15/2021'
    );
  });
  ...
  it('should delete test', () => {
    cy.get(
      ':nth-child(2) > :nth-child(9) > .MuiLink-root > .MuiBox-root > .MuiTypography-root'
    ).click();
