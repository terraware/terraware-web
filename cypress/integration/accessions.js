...
describe("Accessions", () => {
  ...
  context("Accessions", () => {
    it("should create the accession", () => {
      ...
      cy.get('#endangered > .MuiButtonBase-root > .MuiIconButton-label > .jss111').should('have.value', "true");
      cy.get('#rare > .MuiButtonBase-root > .MuiIconButton-label > .jss111').should('have.value', "true");
